...
function useIceServers(config) {
    ...
    var _g = react.useState(), iceServers = _g[0], setIceServers = _g[1];
...
function useSignalingClient(config) {
    ...
    var _f = react.useState(), signalingClient = _f[0], setSignalingClient = _f[1];
    var _g = react.useState(), signalingClientError = _g[0], setSignalingClientError = _g[1];
    ...
    react.useEffect(function () {
        ...
        setSignalingClient(new KVSWebRTC.SignalingClient({
            channelARN: channelARN,
...
function useMasterPeerConnections(config) {
    ...
    var role = KVSWebRTC.Role.MASTER;
...
function useViewerPeerConnection(config) {
    var channelARN = config.channelARN, credentials = config.credentials, region = config.region;
    var role = KVSWebRTC.Role.VIEWER;
