...
function useIceServers(config) {
    var channelARN = config.channelARN, channelEndpoint = config.channelEndpoint, _a = config.credentials, _b = _a === void 0 ? {} : _a, _c = _b.accessKeyId, accessKeyId = _c === void 0 ? "" : _c, _d = _b.secretAccessKey, secretAccessKey = _d === void 0 ? "" : _d, _e = _b.sessionToken, sessionToken = _e === void 0 ? "" : _e, region = config.region;
    var _f = useState(), error = _f[0], setError = _f[1];
    var _g = useState(), iceServers = _g[0], setIceServers = _g[1];
    useEffect(function () {
        if (!channelEndpoint) {
            return;
        }
        var kinesisVideoSignalingChannelsClient = new KinesisVideoSignalingClient({
            region: region,
            credentials: {
        ...
        var getIceServerConfigCommand = new GetIceServerConfigCommand({
...
function useLocalMedia(_a) {
    ...
    var _d = useState(), media = _d[0], setMedia = _d[1];
...
function useSignalingChannelEndpoints(config) {
    ...
    var _b = useState(), signalingChannelEndpoints = _b[0], setSignalingChannelEndpoints = _b[1];
    if (!channelARN) {
...
function useSignalingClient(config) {
    var channelARN = config.channelARN, channelEndpoint = config.channelEndpoint, _a = config.credentials, _b = _a === void 0 ? {} : _a, _c = _b.accessKeyId, accessKeyId = _c === void 0 ? "" : _c, _d = _b.secretAccessKey, secretAccessKey = _d === void 0 ? "" : _d, _e = _b.sessionToken, sessionToken = _e === void 0 ? "" : _e, clientId = config.clientId, kinesisVideoClient = config.kinesisVideoClient, region = config.region, role = config.role;
    var _f = useState(), signalingClient = _f[0], setSignalingClient = _f[1];
    var _g = useState(), signalingClientError = _g[0], setSignalingClientError = _g[1];
    ...
    useEffect(function () {
        ...
        setSignalingClient(new SignalingClient({
            channelARN: channelARN,
...
function useMasterPeerConnections(config) {
    ...
    var kinesisVideoClientRef = useRef(new KinesisVideo({
        region: region,
...
function useViewerPeerConnection(config) {
    ...
    var kinesisVideoClient = kinesisVideoClientRef.current;
    var _a = useState(), peerConnection = _a[0], setPeerConnection = _a[1];
    var _b = useState(), peerMedia = _b[0], setPeerMedia = _b[1];
